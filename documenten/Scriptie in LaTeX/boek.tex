...
\renewcommand\lstlistingname{Codevoobeeld}
\renewcommand\lstlistlistingname{Codevoorbeelden}
%\def\lstlistingautorefname{Codevoorbeeld}
...
% titelblad (voor kaft)
%\include{titel}
\includepdf[pages=-,offset=2.5cm -2cm]{titelblad.pdf}
...
\include{Drupal}
\include{CoAP}
\include{CoAPLibraryModule}
\include{CoAPSensorModule}
\include{uitbreidingen}
