...
\vspace{-30pt}
\caption{Navigatie naar configuratie}
\vspace{-10pt}
\end{figure}
...
Voor optie 28 (Size) en 27 (Block1) bieden we nog geen ondersteuning, momenteel worden ze genegeerd.

\section{Anonieme users}
Momenteel worden anonieme users niet meer ondersteund. Dit kan gebeuren door gebruik te maken van de sessievariabele \cite{sessionVariable}.