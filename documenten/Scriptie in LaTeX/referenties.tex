...
\bibitem{webLinking} http://tools.ietf.org/html/rfc5988
...
\bibitem{googleCharts} https://developers.google.com/chart/

\bibitem{viewsModule} http://drupal.org/project/views

\bibitem{entityReference} http://drupal.org/project/entityreference

\bibitem{sessionVariable} http://drupal.org/node/33513

\bibitem{hostByAddr} http://php.net/manual/en/function.gethostbyaddr.php

\bibitem{hostByName} http://php.net/manual/en/function.gethostbyname.php
