...
\textbf{hier moet nog wat uitleg bij, want floris dacht denk ik dat alle implementaties van alle hooks worden opgeroepen}
...
De informatie bijhorende bij een Field wordt verspreid over verschillende tabellen die weergegeven worden in Figuur~. We geven een korte beschrijving van deze tabellen:
\begin{itemize}
...
\item field\_revision\_\textit{naam\_field}: Bevat archiveringswaarden bijhorende bij verschillende revisions van het veld zodat teruggekeerd kan worden naar een vorige revision.
\end{itemize}
