...
In het vierde hoofdstuk bespreken we de ontwikkelde CoAP library. %achtergrondprocessen, push vs pull, ... kan hierbij

In het vijfde hoofdstuk bespreken we de sensormodule. %architectuur, geschiedenis van opgravingen, users, ... kan hierbij
